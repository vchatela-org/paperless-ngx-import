...
REGISTRY_URL="harbor.k3s.internal.valentincloud.fr"
...
if [[ $REPLY =~ ^[Yy]$ ]]; then
    ...
    echo -e "${GREEN}✓ Available at: https://harbor.k3s.internal.valentincloud.fr/harbor/projects/${PROJECT_NAME}/repositories${NC}"
