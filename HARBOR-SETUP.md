...
1. **Login** to Harbor: https://harbor.k3s.internal.valentincloud.fr/
2. **Create Project**:
...
The script will:
- Build the image as `harbor.k3s.internal.valentincloud.fr/import-paperless-ngx/paperless-import:latest`
...
kubectl create secret docker-registry harbor-secret \
  --docker-server=harbor.k3s.internal.valentincloud.fr \
...
kubectl run test-pull --image=harbor.k3s.internal.valentincloud.fr/import-paperless-ngx/paperless-import:latest --namespace=paperless --rm -it --restart=Never -- echo "Image pull successful"
...
- **Registry**: `harbor.k3s.internal.valentincloud.fr`
- **Project**: `import-paperless-ngx` (Public)
- **Repository**: `paperless-import`
- **Full URL**: `harbor.k3s.internal.valentincloud.fr/import-paperless-ngx/paperless-import:latest`
- **Web UI**: https://harbor.k3s.internal.valentincloud.fr/harbor/projects
...
```bash
# Test Docker login
docker pull harbor.k3s.internal.valentincloud.fr/import-paperless-ngx/paperless-import:latest
...
kubectl run debug --image=harbor.k3s.internal.valentincloud.fr/import-paperless-ngx/paperless-import:latest --namespace=paperless --rm -it --restart=Never -- /bin/bash
```
...
1. Go to https://harbor.k3s.internal.valentincloud.fr/
